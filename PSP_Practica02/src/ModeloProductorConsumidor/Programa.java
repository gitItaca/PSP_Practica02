...
public class Programa {
	...
	public static void main(String[] args) {
		PilaNumeros pila = new PilaNumeros(3); //los productos maximos que salgan tendrían que ser 3.
		Productor productor = new Productor(1, pila, 8);
		Consumidor consumidor = new Consumidor(1, pila, 1);
